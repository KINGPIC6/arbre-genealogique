...
## Après la Priorité 8 — dette identifiée traitée

- Navigation clavier de l'arbre (flèches/+/-/0) : était marquée PARTIAL
  dans `design/DESIGN_REVIEW.md`, maintenant PASS. Build re-vérifié.
